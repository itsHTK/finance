   ...
   'fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 overflow-y-auto',
   {
      variants: {
         side: {
            ...
            right: 'inset-y-0 lg:inset-y-3 right-0 lg:right-3 h-full lg:h-[calc(100vh-1.25rem)] w-full border-l lg:rounded-xl data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right lg:max-w-md',
            rightOld:
